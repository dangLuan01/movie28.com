                ...
                <div class="main__table-wrap">
                    <table class="main__table">
                        ...
                        <tbody>
                            ...
                            @foreach ($model['items'] as $genre)
                            <tr>
                                <td>
                                    <div class="main__table-text">{{$genre['id']}}</div>
                                </td>
                                <td>
                                    <div class="main__table-text"><img src="{{ 'https://wsrv.nl/?url=' . $genre['image'] ?? ''}}" alt="" width="110px"></div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="main__table-btns">
                                        <a href="{{route('movie.genre.status', ['status' => $genre['status'], 'id' => $genre['id']])}}"
                                        ...
                                        <a href="{{route('movie.genre.edit', ['genre' => $genre['id']])}}" class="main__table-btn main__table-btn--edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
